...
export default function SavedItem({ title, dueDate, goalAmount, monthlyContribution, currentAmount }) {
  ...
  return (
      ...
      <div className="bg-white rounded-3xl shadow-lg p-6 w-full max-w-sm">
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">+ {monthlyContribution.toFixed(2)} each month</p>
            </div>
          </div>
          <button
        ...
        {/* Top Up Button */}
        <button className="w-full bg-purple-500 hover:bg-purple-600 text-white font-semibold py-3.5 rounded-2xl transition-colors flex items-center justify-center gap-2">
